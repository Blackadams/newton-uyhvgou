...
> Be patient! In ~3 mins your app is live, at your [app url](http://newton-uyhvgou.newton.wiki/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: http://newton-uyhvgou.newton.wiki/
...
```
git clone git@github.com:Blackadams/newton-uyhvgou.git
```
